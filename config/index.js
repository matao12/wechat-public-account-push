export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx63fba3c0cb8fd81e",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "dfb6dabb4fb3a8a4168e97afb31d9522",
  ...
  USERS: [
    {
      ...
      id: "o3YxU6mV5_lXLs9Ly1YdcXe5Q5Is,o3YxU6hBS7bDJAUL1dYqek7gn_ck",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "whqGuQsNhRYp9fExmfDQqD9_RK1kKaC6eTqVsfgRkM4",
      // 所在省份
      province: "河南",
      // 所在城市
      city: "郑州",
      ...
      festivals: [
        ...
        {"type": "生日", "name": "你个小笨蛋", "year": "2001", "date": "04-06"},
